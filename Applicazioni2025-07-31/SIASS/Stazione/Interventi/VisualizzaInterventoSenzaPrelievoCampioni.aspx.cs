...
namespace SIASS
{
	public partial class VisualizzaInterventoSenzaPrelievoCampioni : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			if (!Page.IsPostBack)
			{
				...
				{
					Response.Redirect($"VisualizzaIntervento.aspx?IdIntervento={idIntervento}");
				}
