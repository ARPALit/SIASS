...
--%>
<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageResponsive.Master" AutoEventWireup="true" CodeBehind="ModificaAllegatoIntervento.aspx.cs" Inherits="SIASS.ModificaAllegatoIntervento" %>

<%@ Register Src="../HeaderInterventoResponsive.ascx" TagName="HeaderInterventoResponsive" TagPrefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>SIASS - Allegato intervento</title>
</asp:Content>
