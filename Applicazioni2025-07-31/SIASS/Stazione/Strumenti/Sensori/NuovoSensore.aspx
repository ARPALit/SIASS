...
--%>
<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageResponsive.Master" AutoEventWireup="true" CodeBehind="NuovoSensore.aspx.cs" Inherits="SIASS.NuovoSensore" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="mb-3" style="max-width: 500px">
        <asp:Label ID="Label2" runat="server" Text="Codice identificativo:" AssociatedControlID="CodiceIdentificativoTextBox" CssClass="form-label"></asp:Label>
        <asp:TextBox ID="CodiceIdentificativoTextBox" runat="server" CssClass="form-control" MaxLength="30" AutoCompleteType="Disabled"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="Codice identificativo: Obbligatorio" ControlToValidate="CodiceIdentificativoTextBox" CssClass="badge bg-danger" Display="Dynamic">Obbligatorio</asp:RequiredFieldValidator>
    </div>
    <div class="mb-3" style="max-width: 500px">
    ...
    <asp:Panel ID="DatiSensoreNonVisibileInterventoPanel" runat="server">
        ...
        <div class="mb-3" style="max-width: 500px">
            ...
            <asp:RangeValidator ID="RangeValidator2" runat="server" ControlToValidate="CoefficienteConversioneUnitaMisuraTextBox" CssClass="badge bg-danger" Display="None" ErrorMessage="Coefficiente conversione unità di misura: Deve essere un numero" MaximumValue="9999999" MinimumValue="0" Type="Double">Deve essere un numero</asp:RangeValidator>
        </div>
    </asp:Panel>
    <div class="my-lg-3">
