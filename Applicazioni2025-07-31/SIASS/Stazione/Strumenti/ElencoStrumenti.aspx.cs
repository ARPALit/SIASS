...
namespace SIASS
{
    public partial class ElencoStrumenti : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
			...
			if (!Page.IsPostBack)
            {
                ...
                NuovoHyperLink.NavigateUrl = $"NuovoStrumento.aspx?IdStazione={idStazione}";
                NuovoHyperLink.Visible = oper.SeAmministrazione;
            }

        }

        private void AggiornaElencoStrumenti()
        {
            decimal idStazione = decimal.Parse(Request.QueryString["IdStazione"]);
            var elencoStrumenti = StrumentoManager.ElencoStrumenti(idStazione);
