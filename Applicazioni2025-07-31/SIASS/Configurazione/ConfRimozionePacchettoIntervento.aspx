...
--%>
<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageResponsive.Master" AutoEventWireup="true" CodeBehind="ConfRimozionePacchettoIntervento.aspx.cs" Inherits="SIASS.ConfRimozionePacchettoIntervento" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1>Rimozione pacchetto intervento</h1>
    <asp:MultiView ID="ConfigurazioneMultiView" runat="server">
        <asp:View ID="SelezionePacchettoView" runat="server">
            <div class="row g-3 mb-3 small">
                <div class="col-2">
                    <asp:Label ID="Label12" runat="server" Text="Selezione pacchetto:" AssociatedControlID="ElencoTipiPacchettoDropDownList" CssClass="form-label"></asp:Label>
                    <asp:DropDownList ID="ElencoTipiPacchettoDropDownList" runat="server" CssClass="form-select" DataTextField="DESCRIZIONE_PACCHETTO" DataValueField="ID_PACCHETTO"></asp:DropDownList>
                </div>
            </div>
        ...
        <asp:View ID="SelezioneStazioniView" runat="server">
            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                <Triggers>
                    ...
                    <asp:PostBackTrigger ControlID="RimuoviButton" />
                </Triggers>
                <ContentTemplate>
                    <div class="row g-3 mb-3 small">
                        <div class="col-md-2">
                        ...
                        <div class="col-12">
                            ...
                            <asp:Button ID="RimuoviButton" runat="server" Text="Rimuovi pacchetto" CssClass="btn btn-primary" CausesValidation="False" OnClick="RimuoviButton_Click" />
                        </div>
                    </div>
                </ContentTemplate>
            </asp:UpdatePanel>
        ...
        <asp:View ID="ConfermaView" runat="server">
            ...
            <asp:Button ID="ConfermaButton" runat="server" Text="Rimuovi" CssClass="btn btn-success my-3" OnClick="ConfermaButton_Click" />
        </asp:View>
