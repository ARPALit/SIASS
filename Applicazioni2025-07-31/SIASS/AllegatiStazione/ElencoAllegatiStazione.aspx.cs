...
namespace SIASS
{
    public partial class ElencoAllegatiStazione : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
			...
			if (!Page.IsPostBack)
            {
                ...
                logger.Debug($"Elenco allegati idStazione:{idStazione}");
                ...
                ElencoAllegatiStazioneGridView.DataSource = AllegatoStazioneManager.ElencoAllegatiStazione(idStazione);
                ElencoAllegatiStazioneGridView.DataBind();

                NuovoHyperLink.NavigateUrl = $"NuovoAllegatoStazione.aspx?IdStazione={idStazione}";
            }
        }
