...
--%>
<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageResponsive.Master" AutoEventWireup="true" CodeBehind="ConfRimozioneGrandezzaCampo.aspx.cs" Inherits="SIASS.ConfRimozioneGrandezzaCampo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1>Rimozione grandezza misurabile sul campo</h1>
                ...
                <ContentTemplate>
                    <div class="row g-3 mb-3 small">
                        ...
                        <div class="col-12">
                            ...
                            <asp:Button ID="RimuoviButton" runat="server" Text="Rimuovi grandezza" CssClass="btn btn-primary" CausesValidation="False" OnClick="RimuoviButton_Click" />
                        </div>
                    </div>
                </ContentTemplate>
            </asp:UpdatePanel>
