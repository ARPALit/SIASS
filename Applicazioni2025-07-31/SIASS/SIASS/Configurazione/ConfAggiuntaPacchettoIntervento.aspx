...
--%>
<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageResponsive.Master" AutoEventWireup="true" CodeBehind="ConfAggiuntaPacchettoIntervento.aspx.cs" Inherits="SIASS.ConfAggiuntaPacchettoIntervento" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1>Aggiunta pacchetto intervento</h1>
                ...
                <ContentTemplate>
                    <div class="row g-3 mb-3 small">
                        ...
                        <div class="col-12">
                            ...
                            <asp:Button ID="AggiungiButton" runat="server" Text="Aggiungi pacchetto" CssClass="btn btn-primary" CausesValidation="False" OnClick="AggiungiButton_Click" />
                        </div>
                    </div>
                </ContentTemplate>
            </asp:UpdatePanel>
