...
namespace SIASS
{
    public partial class ElencoDatiAmministrativi : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
			...
			if (!Page.IsPostBack)
            {
                ...
                logger.Debug($"ElencoDatiAmministrativi {idStazione}");
                ElencoDatiAmministrativiGridView.DataSource = DatiAmministrativiManager.ElencoDatiAmministrativi(idStazione);
                ElencoDatiAmministrativiGridView.DataBind();
                ...
                NuovoHyperLink.NavigateUrl = $"NuovoDatiAmministrativi.aspx?IdStazione={idStazione}";
            }
