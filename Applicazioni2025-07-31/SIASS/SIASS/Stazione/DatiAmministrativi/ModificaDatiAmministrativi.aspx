...
--%>
<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageResponsive.Master" AutoEventWireup="true" CodeBehind="ModificaDatiAmministrativi.aspx.cs" Inherits="SIASS.ModificaDatiAmministrativi" %>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Elimina dati amministrativi</h5>
                </div>
                <div class="modal-body">
                    Eliminare questi dati amministrativi?
                </div>
