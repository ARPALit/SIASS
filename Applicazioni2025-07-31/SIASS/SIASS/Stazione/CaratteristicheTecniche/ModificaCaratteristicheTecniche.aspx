...
--%>
<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageResponsive.Master" AutoEventWireup="true" CodeBehind="ModificaCaratteristicheTecniche.aspx.cs" Inherits="SIASS.ModificaCaratteristicheTecniche" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1>Modifica caratteristiche tecniche</h1>
    ...
    <div class="mb-3" style="max-width: 500px">
        ...
        <asp:TextBox ID="ProfonditaTextBox" runat="server" CssClass="form-control" MaxLength="6" AutoCompleteType="Disabled"></asp:TextBox>
    ...
    <div class="mb-3" style="max-width: 500px">
        ...
        <asp:TextBox ID="DiametroTextBox" runat="server" CssClass="form-control" AutoCompleteType="Disabled"></asp:TextBox>
    ...
    <div class="mb-3" style="max-width: 500px">
        ...
        <asp:TextBox ID="RangeSoggiacenzaDaTextBox" runat="server" CssClass="form-control" MaxLength="10" AutoCompleteType="Disabled"></asp:TextBox>
    ...
    <div class="mb-3" style="max-width: 500px">
        ...
        <asp:TextBox ID="RangeSoggiacenzaATextBox" runat="server" CssClass="form-control" MaxLength="10" AutoCompleteType="Disabled"></asp:TextBox>
    ...
    <div class="mb-3" style="max-width: 500px">
        ...
        <asp:TextBox ID="QuotaBoccapozzoPcTextBox" runat="server" CssClass="form-control" MaxLength="10" AutoCompleteType="Disabled"></asp:TextBox>
    ...
    <div class="mb-3" style="max-width: 500px">
        ...
        <asp:TextBox ID="QuotaBoccapozzoSlmTextBox" runat="server" CssClass="form-control" MaxLength="10" AutoCompleteType="Disabled"></asp:TextBox>
    ...
    <div class="mb-3" style="max-width: 500px">
        ...
        <asp:TextBox ID="QuotaPianoRiferimentoSlmTextBox" runat="server" CssClass="form-control" MaxLength="10" AutoCompleteType="Disabled"></asp:TextBox>
    ...
    <div class="mb-3" style="max-width: 500px">
        ...
        <asp:TextBox ID="DifferenzaPrpcTextBox" runat="server" CssClass="form-control" MaxLength="10" AutoCompleteType="Disabled"></asp:TextBox>
    ...
    <div class="mb-3" style="max-width: 500px">
        ...
        <asp:TextBox ID="ProfonditaEmungimentoTextBox" runat="server" CssClass="form-control" MaxLength="10" AutoCompleteType="Disabled"></asp:TextBox>
    ...
    <div class="mb-3" style="max-width: 500px">
        ...
        <asp:TextBox ID="PortataMassimaEsercizioTextBox" runat="server" CssClass="form-control" MaxLength="10" AutoCompleteType="Disabled"></asp:TextBox>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Elimina caratteristiche tecniche</h5>
                </div>
                <div class="modal-body">
                    Eliminare questa caratteristiche tecniche?
                </div>
