...
namespace SIASS
{
    public partial class ElencoLocalizzazioni : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
			...
			if (!Page.IsPostBack)
            {
                ...
                ElencoLocalizzazioniGridView.DataSource = LocalizzazioneManager.ElencoLocalizzazioni(idStazione);
                ElencoLocalizzazioniGridView.DataBind();
                ...
                NuovoHyperLink.NavigateUrl = $"NuovaLocalizzazione.aspx?IdStazione={idStazione}";
            }
