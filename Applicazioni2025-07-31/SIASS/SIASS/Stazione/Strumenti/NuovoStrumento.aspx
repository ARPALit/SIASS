...
--%>
<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageResponsive.Master" AutoEventWireup="true" CodeBehind="NuovoStrumento.aspx.cs" Inherits="SIASS.NuovoStrumento" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1>Nuovo strumento</h1>
    <asp:ValidationSummary ID="ValidationSummary1" runat="server" CssClass="alert alert-danger" />
    <div class="mb-3" style="max-width: 500px">
        <asp:Label ID="Label2" runat="server" Text="Tipo:" AssociatedControlID="TipiStrumentoDropDownList" CssClass="form-label"></asp:Label>
        <asp:DropDownList ID="TipiStrumentoDropDownList" runat="server" DataTextField="DESCRIZIONE_TIPO_STRUMENTO" DataValueField="ID_TIPO_STRUMENTO" CssClass="form-select" AutoPostBack="True" OnSelectedIndexChanged="TipiStrumentoDropDownList_SelectedIndexChanged">
        </asp:DropDownList>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Tipo: Obbligatorio" ControlToValidate="TipiStrumentoDropDownList" CssClass="badge bg-danger" Display="None">Obbligatorio</asp:RequiredFieldValidator>
    </div>
