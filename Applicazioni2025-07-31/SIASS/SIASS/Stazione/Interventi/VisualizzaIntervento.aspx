...
--%>
<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageResponsive.Master" AutoEventWireup="true" CodeBehind="VisualizzaIntervento.aspx.cs" Inherits="SIASS.VisualizzaIntervento" %>

<%@ Register Src="~/Stazione/HeaderStazioneResponsive.ascx" TagPrefix="uc1" TagName="HeaderStazioneResponsive" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>SIASS - Visualizza intervento</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-2">
            <asp:Label ID="Label17" runat="server" Text="Numero campioni:"></asp:Label>
            <asp:Label ID="NumeroCampioniLabel" runat="server"></asp:Label>
        </div>
        <div class="col-1">
    ...
    <div class="row mb-3">
        <div class="col">
            <asp:Label ID="Label1" runat="server" Text="Dati campione bianco:"></asp:Label>
            <asp:Label ID="DatiCampioneBiancoLabel" runat="server"></asp:Label>
        </div>
    </div>
    ...
    <div class="col my-2 border border-1">
        <div class="p-2">
            <h2>Pacchetti</h2>
            <asp:GridView ID="PacchettiGridView" runat="server" CssClass="table table-bordered small w-auto" AutoGenerateColumns="False">
                <Columns>
            ...
            <div class="row mb-3">
                <div class="col">
                    <asp:Label ID="Label9" runat="server" Text="Annotazioni pacchetti:"></asp:Label>
                    <asp:Label ID="AnnotazioniPacchettiLabel" runat="server"></asp:Label>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col my-2 border border-1">
        <div class="p-2">
            <h2>Analiti</h2>
            <asp:GridView ID="AnalitiInterventoGridView" runat="server" CssClass="table table-bordered small w-auto" DataKeyNames="Codice" AutoGenerateColumns="false" EmptyDataText="Nessun analita.">
                <Columns>
