...
<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageResponsive.Master" AutoEventWireup="true" CodeBehind="NuovoInterventoSenzaPrelievoCampioni.aspx.cs" Inherits="SIASS.NuovoInterventoSenzaPrelievoCampioni" %>

<%@ Register Src="~/Stazione/HeaderStazioneResponsive.ascx" TagPrefix="uc1" TagName="HeaderStazioneResponsive" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>SIASS - Nuovo intervento senza prelievo di campioni</title>
</asp:Content>
