...
namespace SIASS
{
	public partial class VisualizzaInterventoV1 : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			if (!Page.IsPostBack)
			{
				...
				// Popola dati
				TipoInterventoLabel.Text = HttpUtility.HtmlEncode(infoIntervento.DescrizioneTipoIntervento);
				ArgomentoLabel.Text = HttpUtility.HtmlEncode(infoIntervento.DescrizioneArgomento);
				MatriceLabel.Text = HttpUtility.HtmlEncode(infoIntervento.DescrizioneMatrice);
				SedeAccettazioneLabel.Text = HttpUtility.HtmlEncode(infoIntervento.DenominazioneSedeAccettazione);
				...
				DatiCampioneBiancoLabel.Text = HttpUtility.HtmlEncode(infoIntervento.DatiCampioneBianco);

				FileDatiLabel.Text = infoIntervento.FileDati;
				if (infoIntervento.IdStrumento.HasValue)
					StrumentoInterventoLabel.Text = HttpUtility.HtmlEncode(infoIntervento.DescrizioneStrumento);
