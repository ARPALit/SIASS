...
public partial class SIAS_GRANDEZZE_STAZIONE
{
	...
	public decimal NUMERO_DECIMALI { get; set; }

	public virtual SIASS_STAZIONI ID_STAZIONENavigation { get; set; }

	public virtual ICollection<SIAS_MISURAZIONI> SIAS_MISURAZIONI { get; set; } = new List<SIAS_MISURAZIONI>();
}
